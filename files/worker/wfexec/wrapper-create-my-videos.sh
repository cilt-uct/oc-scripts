#!/bin/bash
# wrapper-create-my-videos.sh
# Wrapper to safely run create-my-videos.pl as the opencast user
# Usage: wrapper-create-my-videos.sh <mediapackage-id> <output-file>

SCRIPT="/opt/opencast/wfexec/create-my-videos.pl"
