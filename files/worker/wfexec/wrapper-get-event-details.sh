#!/bin/bash
# wrapper-get-event-details.sh
# Wrapper to safely run get-event-details.pl as the opencast user
# Usage: wrapper-get-event-details.sh <mediapackage-id> <output-file>

SCRIPT="/opt/opencast/wfexec/get-event-details.pl"
