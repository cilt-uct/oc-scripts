...
select 'oc_annotation' as 'ON';
RENAME TABLE mh_annotation TO oc_annotation;

#Prescript change
ALTER TABLE oc_annotation RENAME INDEX IX_mh_annotation_user_id TO IX_mh_annotation_user;
#End Prescript
...
select 'oc_capture_agent_*' as 'ON';
...
#Prescript change
ALTER TABLE oc_capture_agent_role RENAME INDEX IX_mh_capture_agent_role TO IX_mh_capture_agent_role_pk;
#End Prescript
...
#Prescript change
#ALTER TABLE mh_capture_agent_state ADD CONSTRAINT FK_mh_capture_agent_state_organization FOREIGN KEY (organization) REFERENCES mh_organization (id) ON DELETE CASCADE;
#End Prescript
...
select 'oc_service_registration' as 'ON';
...
#Prescript change
ALTER TABLE oc_job_oc_service_registration RENAME INDEX mhjobmhservice_registrationservicesRegistration_id TO IX_mh_job_mh_service_registration_servicesRegistration_id;
#End Prescript
...
select 'oc_ibm_watson_transcript_job' as 'ON';
